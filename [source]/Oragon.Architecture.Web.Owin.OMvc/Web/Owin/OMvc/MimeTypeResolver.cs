...
namespace Oragon.Architecture.Web.Owin.OMvc
{
	public static class MimeTypeResolver
	{
		...
		{
			return MimeTypeResolver.ResolveMimeType(new Uri(path));
		}

		public static string ResolveMimeType(Uri uri)
		{
			var fileInfo = new System.IO.FileInfo(uri.AbsolutePath);
			var extension = fileInfo.Extension;
			if (string.IsNullOrWhiteSpace(extension) || MimeTypeResolver.MimeTypes.ContainsKey(extension) == false)
				return null;
			else
			{
