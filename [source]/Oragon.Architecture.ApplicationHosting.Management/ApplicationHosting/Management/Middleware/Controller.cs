...
namespace Oragon.Architecture.ApplicationHosting.Management.Middleware
{
	public abstract class Controller
	{
		...
		protected string ResolveMimeType(Uri uri)
		{
			var fileInfo = new System.IO.FileInfo(uri.AbsolutePath);
			var extension = fileInfo.Extension;
			if (string.IsNullOrWhiteSpace(extension) || Controller.MimeTypes.ContainsKey(extension) == false)
				return null;
			else
			{
				return Controller.MimeTypes[extension];
			}
		}
