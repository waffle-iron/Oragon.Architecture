...
namespace Oragon.Architecture.ApplicationHosting.Management.WebMvcControllers
{
	public class HomeController : OMvcController
	{
		public MvcResult Index(string style = "classic")
		{
			...
			.Script("/dynRes/ApplicationHosting/Management/Script/Frameworks/Oragon.TreeViewManager.js")
			.Script("/dynRes/ApplicationHosting/Management/Script/Home.Controller.js")
			.Script("/dynRes/ApplicationHosting/Management/Script/Home.View.js")
			.CloseHead()
			.OpenBody()
			.CloseBody()
			.CloseHtml();
