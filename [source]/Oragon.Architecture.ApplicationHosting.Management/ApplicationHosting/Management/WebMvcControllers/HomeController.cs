...
namespace Oragon.Architecture.ApplicationHosting.Management.WebMvcControllers
{
	public class HomeController : OMvcController
	{
		public MvcResult Index(string style = "classic")
		{
			...
			//.WriteLine("Ext.Loader.setConfig({enabled: true});")
			//.WriteLine("Ext.Loader.setPath('Oragon.Architecture.ApplicationHosting.Management', '/dynRes/ApplicationHosting/Management/WebResources/Script');")
			//.WriteLine("Ext.require(['*']);")
			...
			.Script("/dynRes/ApplicationHosting/Management/WebResources/Script/Frameworks/Managers/Reflection.js")
			.Script("/dynRes/ApplicationHosting/Management/WebResources/Script/Frameworks/Managers/AjaxManager.js")
			.Script("/dynRes/ApplicationHosting/Management/WebResources/Script/Frameworks/Managers/ErrorManager.js")
			.Script("/dynRes/ApplicationHosting/Management/WebResources/Script/Frameworks/Managers/TreeViewManager.js")
			.Script("/dynRes/ApplicationHosting/Management/WebResources/Script/Frameworks/Managers/TimerManager.js")
			.Script("/dynRes/ApplicationHosting/Management/WebResources/Script/Frameworks/Managers/WaitingManager.js")
