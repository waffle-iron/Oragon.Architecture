...
namespace Oragon.CodeGen.MetaData.DataBase
{
	...
	public interface IMyMetaPlugin
    {
        ...
        /// <summary>
        /// A name for the Oragon.CodeGen.MetaData.DataBase provider.
        /// </summary>
        ...
        */
        ...
        /// 
        /// The MyMetaObject match a specific Oragon.CodeGen.MetaData.DataBase object of a type like IColumn, ITable, IView, IProcedure, etc.
