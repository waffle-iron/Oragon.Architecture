...
namespace Oragon.CodeGen.MetaData.DataBase
{
	...
	/// <code>
	/// Dim objDatabase
	/// For Each objDatabase in Oragon.CodeGen.MetaData.DataBase.Databases
	...
	/// <code>
	/// var objDatabase;
	/// for (var j = 0; j &lt; Oragon.CodeGen.MetaData.DataBase.Databases.Count; j++) 
	/// {
	///	    objDatabase = Oragon.CodeGen.MetaData.DataBase.Databases.Item(j);
	///	    
	///	    output.writeln(objDatabase.Name);
	///	    output.writeln(objDatabase.Alias);
	/// }
	...
	public interface IDatabase
	{
		...
		/// To save any data added to this collection call Oragon.CodeGen.MetaData.DataBase.SaveUserMetaData(). See <see cref="IProperty"/>
		/// </summary>
		...
		/// You can provide an Alias the User Meta Data window. You can also set this during a script and then call Oragon.CodeGen.MetaData.DataBase.SaveUserMetaData().
		/// See <see cref="Name"/>
		/// </summary>
		[DispId(0)]
