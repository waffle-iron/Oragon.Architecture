...
namespace Oragon.Architecture.Workflow.QueuedWorkFlow
{
    public class QueuedWorkflowMessageListenerAdapter : IMessageListener, IChannelAwareMessageListener
    {
        ...
        public void OnMessage(Message message, IModel channel)
        {
            ...
            bool success = this.InvokeListenerMethod(this.DefaultListenerMethod, arguments);
            if (success)
                this.HandleSuccessResult(messageObject, message, channel);
            else
        ...
        protected virtual void HandleSuccessResult(object result, Message request, IModel channel)
        {
